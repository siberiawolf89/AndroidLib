...
public class ImageLoadConfig {
    ...
    private Integer colorFilter; //遮罩一层颜色
    ...
    public static class Builder {
        ...
        public Builder setColorFilter(Integer colorFilter) {
    ...
    public static Builder parseBuilder(ImageLoadConfig config) {
        ...
        builder.rounded = config.rounded;
        builder.cornerType = config.cornerType;
