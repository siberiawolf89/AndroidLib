package com.jiuli.library.utils.okhttp.request;

import android.text.TextUtils;
import android.util.Pair;
import android.widget.ImageView;

import com.jiuli.library.utils.okhttp.OkHttpClientManager;
...
public abstract class OkHttpRequest
{
    ...
    public static class Builder
    {
        ...
        {
            OkHttpRequest request = new OkHttpPostRequest(url, tag, params, headers, mediaType, content,json, bytes, file);
            return request.invoke(clazz);
        }
