...
public class BGAPhotoFolderPw extends BGABasePopupWindow implements LibraryOnRVItemClickListener {
    ...
    private class FolderAdapter extends LibraryRecyclerViewAdapter<BGAImageFolderModel> {
        ...
        @Override
        protected void fillData(LibraryViewHolderHelper helper, int position, BGAImageFolderModel model) {
            ...
            BGAImage.displayImage(mActivity, helper.getImageView(R.id.iv_item_photo_folder_photo), model.coverPath, R.drawable.bga_pp_ic_holder_light, R.drawable.bga_pp_ic_holder_light, mImageWidth, mImageHeight, null);
        }
    }
