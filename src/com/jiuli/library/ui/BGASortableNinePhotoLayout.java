...
import com.jiuli.library.adapter.LibraryOnRVItemClickListener;
import com.jiuli.library.adapter.LibraryRecyclerViewAdapter;
import com.jiuli.library.adapter.LibraryRecyclerViewHolder;
import com.jiuli.library.adapter.LibraryViewHolderHelper;
import com.jiuli.library.utils.BGAPhotoPickerUtil;
import com.jiuli.library.utils.BGASpaceItemDecoration;
...
public class BGASortableNinePhotoLayout extends RecyclerView implements LibraryOnItemChildClickListener, LibraryOnRVItemClickListener {
    ...
    private int defAddImg = R.drawable.bga_pp_ic_plus;
    ...
    private void initAttr(int attr, TypedArray typedArray) {
        ...
        }else if(attr == R.styleable.BGASortableNinePhotoLayout_bga_snpl_def_add_img){
            defAddImg = typedArray.getResourceId(attr,R.drawable.bga_pp_ic_plus);
        }
    }
    ...
    private class PhotoAdapter extends LibraryRecyclerViewAdapter<String> {
        ...
        @Override
        protected void setItemChildListener(LibraryViewHolderHelper helper) {
        ...
        protected void fillData(LibraryViewHolderHelper helper, int position, String model) {
            if (isPlusItem(position)) {
                ...
                BGAImageView photoIv = helper.getView(R.id.iv_item_nine_photo_photo);

                ViewGroup.LayoutParams vlp = photoIv.getLayoutParams();
                vlp.width = mImageWidth;
                vlp.height = mImageHeight;
                helper.setImageResource(R.id.iv_item_nine_photo_photo, defAddImg);

            } else {
                helper.setVisibility(R.id.iv_item_nine_photo_flag, View.VISIBLE);
                BGAImage.displayImage(mActivity, helper.getImageView(R.id.iv_item_nine_photo_photo), model, R.drawable.bga_pp_ic_holder_light, R.drawable.bga_pp_ic_holder_light, mImageWidth, mImageHeight, null);
            }
        }
    }
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
                ...
                ((LibraryRecyclerViewHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(getResources().getColor(R.color.bga_pp_photo_selected_mask));
            }
        ...
        public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            ...
            ((LibraryRecyclerViewHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(null);
