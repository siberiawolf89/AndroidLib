 ...
 *******************************************************************************/
package com.jiuli.library.ui.pulltorefresh;
...
import com.jiuli.library.ui.pulltorefresh.internal.FlipLoadingLayout;
import com.jiuli.library.ui.pulltorefresh.internal.LoadingLayout;
import com.jiuli.library.ui.pulltorefresh.internal.RotateLoadingLayout;
import com.jiuli.library.ui.pulltorefresh.internal.Utils;
import com.jiuli.library.ui.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private OnHeaderScrollListener<T> mOnHeaderScrollListener;
	...
	public OnHeaderScrollListener<T> getmOnHeaderScrollListener() {
		return mOnHeaderScrollListener;
	}

	public void setmOnHeaderScrollListener(OnHeaderScrollListener<T> mOnHeaderScrollListener) {
		this.mOnHeaderScrollListener = mOnHeaderScrollListener;
	}
	...
	protected final void setHeaderScroll(int value) {
		...
		if(mOnHeaderScrollListener != null)
			mOnHeaderScrollListener.onHeaderScroll(this,value);
	...
	public static interface OnHeaderScrollListener<V extends View> {

		/**
		 * onRefresh will be called for both a Pull from start, and Pull from
		 * end
		 */
		public void onHeaderScroll(final PullToRefreshBase<V> refreshView,int y);
