...
public class LibraryViewHolderHelper implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected LibraryRecyclerViewHolder mRecyclerViewHolder;
    ...
    public LibraryViewHolderHelper(ViewGroup adapterView, View convertView) {
    ...
    public LibraryViewHolderHelper(RecyclerView recyclerView, View convertView) {
        mViews = new SparseArray<>();
    ...
    public void setRecyclerViewHolder(LibraryRecyclerViewHolder recyclerViewHolder) {
        mRecyclerViewHolder = recyclerViewHolder;
    }

    public LibraryRecyclerViewHolder getRecyclerViewHolder() {
     ...
     * @return
     */
    public LibraryViewHolderHelper setText(@IdRes int viewId, CharSequence text) {
     ...
     * @return
     */
    public LibraryViewHolderHelper setText(@IdRes int viewId, @StringRes int stringResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setHtml(@IdRes int viewId, String source) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setChecked(@IdRes int viewId, boolean checked) {
        Checkable view = getView(viewId);
        view.setChecked(checked);
        return this;
    }

    public LibraryViewHolderHelper setTag(@IdRes int viewId, Object tag) {
        View view = getView(viewId);
        view.setTag(tag);
        return this;
    }

    public LibraryViewHolderHelper setTag(@IdRes int viewId, int key, Object tag) {
        View view = getView(viewId);
        view.setTag(key, tag);
        return this;
    }

    public LibraryViewHolderHelper setVisibility(@IdRes int viewId, int visibility) {
        View view = getView(viewId);
        view.setVisibility(visibility);
        return this;
    }

    public LibraryViewHolderHelper setImageBitmap(@IdRes int viewId, Bitmap bitmap) {
        ImageView view = getView(viewId);
        view.setImageBitmap(bitmap);
        return this;
    }

    public LibraryViewHolderHelper setImageDrawable(@IdRes int viewId, Drawable drawable) {
        ImageView view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setTextColorRes(@IdRes int viewId, @ColorRes int textColorResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setTextColor(@IdRes int viewId, int textColor) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setBackgroundRes(@IdRes int viewId, int backgroundResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setBackgroundColor(@IdRes int viewId, int color) {
        View view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setBackgroundColorRes(@IdRes int viewId, @ColorRes int colorResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public LibraryViewHolderHelper setImageResource(@IdRes int viewId, @DrawableRes int imageResId) {
        ImageView view = getView(viewId);
