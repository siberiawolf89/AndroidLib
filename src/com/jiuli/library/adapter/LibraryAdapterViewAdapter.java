...
public abstract class LibraryAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public LibraryAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final LibraryAdapterViewHolder viewHolder = LibraryAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
